...
import de.isc.emonjava.EmoncmsFactory;
...
public class EmoncmsDemo {
	...
	public static void main(String[] args) {
		...
		Emoncms cms = EmoncmsFactory.newEmoncmsHttpConnection(URL, API_KEY);
		try {
			cms.start();
			...
			List<FeedData> feeds = cms.loadFeedList();
			Feed feed1 = null;
			Feed feed2 = null;
